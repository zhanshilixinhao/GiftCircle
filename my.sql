...
(
  ...
  status   tinyint comment '状态，1-未支付，2-已支付,3-已删除',
  pay_way  tinyint comment '支付方式，1-微信，2-支付宝，',
  created  datetime comment '创建时间',
  updated  datetime comment '更新时间',
  primary key id (id),
...
CREATE TABLE `consignment` (
  ...
  `quantity`  int(10) comment '数量',
  `price`     decimal(18, 2) comment '价格',
  `type`      tinyint(4) comment '1 商品 2-虚拟商品 3 优惠券',
...
CREATE TABLE `gift_exchange` (
  ...
  `status`         tinyint(4) comment '礼品添加状态，1-用户提交，2-好友提交，3-已完成，4-交换失败',
