...
public class WXPayUtil {
    ...
    public static String getSign(HashMap<String, String> map, String key) {
        ...
        result = EncryptUtil.md5(result).toUpperCase();
...
/*
    ...
    *//**
    ...
    public static String generateSignature(final Map<String, String> data, String key, SignType signType) throws Exception {
        ...
        System.out.println("顺序"+sb.toString());
    ...
    public static Logger getLogger() {
        Logger logger = LoggerFactory.getLogger("wxpay java com.cckj.lr.wxmini.thirdapi.wx.sdk");
        return logger;
    }
