...
public class MemberExpenseRecord {
    ...
    public MemberExpenseRecord(Integer id, Integer membershipCardId, Integer userId, BigDecimal expenseMoney, Byte type, Integer storeId, String targetId, Integer adminId, String explain, Date updated, Date created,Long orderNo,BigDecimal beforeMoney) {
        this.id = id;
