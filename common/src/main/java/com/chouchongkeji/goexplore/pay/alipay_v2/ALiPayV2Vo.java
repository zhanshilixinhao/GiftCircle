...
public class ALiPayV2Vo {
    ...
    private String passback_param;      // 回传参数
    ...
    public String getPassback_param() {
        return passback_param;
    }

    public void setPassback_param(String passback_param) {
        this.passback_param = passback_param;
    }
